  ...
  return (
    <div className="space-y-2 animate-slideInUp">
      <div className="text-center">
        <div className="w-12 h-12 bg-gradient-to-br from-red-500 to-red-600 rounded-full mx-auto mb-2 flex items-center justify-center shadow-lg relative group">
          <span className="text-xl">🇨🇦</span>
          <div className="absolute bottom-full left-1/2 transform -translate-x-1/2 mb-2 px-3 py-2 bg-gray-800 text-white text-xs rounded-lg opacity-0 group-hover:opacity-100 transition-opacity duration-200 whitespace-nowrap z-10">
            Let us know where you're located in Canada
          </div>
        </div>
      ...
      <div className="text-center">
        <h3 className="text-xl font-bold text-gray-800 mb-4 relative group">
          ...
          <div className="absolute bottom-full left-1/2 transform -translate-x-1/2 mb-2 px-3 py-2 bg-gray-800 text-white text-xs rounded-lg opacity-0 group-hover:opacity-100 transition-opacity duration-200 whitespace-nowrap z-10">
            This helps us provide province-specific mortgage options
          </div>
        </h3>
            ...
            >
              <div className="flex items-center">
                <div className={`w-16 h-16 rounded-2xl flex items-center justify-center mr-4 transition-all duration-300 ${
                  ...
                  <span className="text-2xl group-hover:scale-110 transition-transform">{province.icon}</span>
                </div>

                <div className="flex-1">
                  <span className="font-bold text-xl block mb-1">{province.label}</span>
                  <span className={`text-sm ${formData.loanDetails.province === province.value ? 'text-gray-700' : 'text-gray-400'}`}>
      ...
      <div className="text-center mt-12">
        <div className="flex items-center justify-center space-x-3 text-gray-600 text-lg">
          ...
          <span className="font-medium">Step 10 of 11</span>
          <div className="text-sm text-gray-900">• One more step!</div>
        </div>
      </div>
    </div>
  );
